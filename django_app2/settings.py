...
TWITTER_CONSUMER_KEY = 'lksk257aPbzDzabhbV100BlIj' # Consumer Key (API Key)
TWITTER_CONSUMER_SECRET = 'GFkDQ55l0LXhFo3cWfGX7NZAvlkN0L3r8PMGCnNGaFJZAvPFxh' # Consumer Secret (API Secret)
